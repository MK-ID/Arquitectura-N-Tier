<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebNotas.aspx.cs" Inherits="CapaPresentacion.WebNotas" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            <div class="jumbotron">
            <h1 class="display-4">Bienvenido al formulario de Notas!</h1>
            ...
            <div class="row">
                <div class="col-4">
                    <form>
                        ...
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Codigo de Curso" runat="server" Id="txtcodCurso"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Semestre" runat="server" Id="txtsemestre"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Parcial 1" runat="server" Id="txtParcial1"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Parcial 2" runat="server" Id="txtParcial2"></asp:TextBox>
                        </div>
                         <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Nota Final" runat="server" Id="txtNotaFinal"></asp:TextBox>
                        </div>
                        <div class="form-row">
...
<asp:ListItem Text="CodCurso" />   
                ...
                <div class="col-8">
                    <p>
                        <asp:GridView class="table table-dark" runat="server" ID="gvNotas">
                        </asp:GridView>
                    </p>
                </div>
            </div>
