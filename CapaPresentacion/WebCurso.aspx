<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebCurso.aspx.cs" Inherits="CapaPresentacion.WebCurso" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            <div class="jumbotron">
            <h1 class="display-4">Bienvenido al formulario de Curso!</h1>
            ...
            <div class="row">
                <div class="col-4">
                    <form>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Código de Curso"  runat="server" Id="txtCodCurso"/>
                         
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Curso" runat="server" Id="txtCurso"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Código de Requisito" runat="server" Id="txtCodRequisito"></asp:TextBox>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <asp:DropDownList CssClass="custom-select" runat="server" Id="ddlCriterio">
                                <asp:ListItem Text="Código de Curso" />
                ...
                <div class="col-8">
                    <p>
                        <asp:GridView class="table table-dark" runat="server" ID="gvCurso">
                        </asp:GridView>
                    </p>
                </div>
            </div>
