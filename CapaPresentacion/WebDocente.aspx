<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebDocente.aspx.cs" Inherits="CapaPresentacion.WebDocente" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            <div class="jumbotron">
            <h1 class="display-4">Bienvenido al formulario de Docente!</h1>
            ...
            <div class="row">
                <div class="col-4">
                    <form>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Código de Docente"  runat="server" Id="txtCodDocente"/>
                        ...
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Apellido Materno" runat="server" Id="txtApeMaterno"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group col-md-4">
                            <asp:DropDownList CssClass="custom-select" runat="server" Id="ddlCriterio">
                                ...
                                <asp:ListItem Text="Apellido Materno" />
                ...
                <div class="col-8">
                    <p>
                        <asp:GridView class="table table-dark" runat="server" ID="gvDocente">
                        </asp:GridView>
                    </p>
                </div>
            </div>
