<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebAlumno.aspx.cs" Inherits="CapaPresentacion.WebAlumno" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            <div class="jumbotron">
            <h1 class="display-4">Bienvenido al formulario de Alumno!</h1>
            <p class="lead">Liste, Genere, Modifique, Elimine y Busque</p>
             ...
             <div class="row">
                <div class="col-4">
                    <form>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Código de Alumno"  runat="server" Id="txtCodAlumno"/>
                         
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Apellido Paterno" runat="server" Id="txtAPaterno"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Apellido Materno" runat="server" Id="txtAMaterno"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Nombres" runat="server" Id="txtNombres"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Usuario" runat="server" Id="txtUsuario"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Contraseña" runat="server" Id="txtContrasena"></asp:TextBox>
                        </div>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Código de Escuela" runat="server" Id="txtCodEscuela"></asp:TextBox>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-group col-md-4">
                            <asp:DropDownList CssClass="custom-select" runat="server" Id="ddlCriterio">
                                <asp:ListItem Text="Código de Alumno" />
                                 <asp:ListItem Text="Apellido Paterno" />
                ...
                <div class="col-8">
                    <p>
                        <asp:GridView class="table table-dark" runat="server" ID="gvAlumno">
                        </asp:GridView>
                    </p>
                </div>
            </div>
