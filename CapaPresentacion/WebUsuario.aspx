<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebUsuario.aspx.cs" Inherits="CapaPresentacion.Usuario" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid">
            <div class="jumbotron">
            <h1 class="display-4">Bienvenido al formulario de Usuario!</h1>
            <p class="lead">Liste, Genere, Modifique, Elimine y Busque</p>
             ...
             <div class="row">
                <div class="col-4">
                    <form>
                        <div class="form-group">
                            <asp:TextBox CssClass="input-group" placeholder="Usuario"  runat="server" Id="txtUsuario"/>
                ...
                <div class="col-8">
                    <p>
                        <asp:GridView class="table table-dark" runat="server" ID="gvUsuario">
                        </asp:GridView>
                    </p>
                </div>
            </div>
